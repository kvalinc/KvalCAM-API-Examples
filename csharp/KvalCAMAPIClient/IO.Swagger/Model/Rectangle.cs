...
namespace IO.Swagger.Model
{
    ...
    public partial class Rectangle : AbstractFeature,  IEquatable<Rectangle>, IValidatableObject
    {
        ...
        public Rectangle(string Bevel = default(string), string Length = default(string), string Width = default(string), string Depth = default(string), string Radius1 = default(string), string Radius2 = default(string), string Radius3 = default(string), string Radius4 = default(string), string Name = default(string), string Description = default(string), string TLocation = default(string), string WLocation = default(string), string LLocation = default(string), DoorSideEnum? DoorSide = default(DoorSideEnum?), List<AbstractFeature> Children = default(List<AbstractFeature>)) : base(Name, Description, TLocation, WLocation, LLocation, DoorSide, Children, "Rectangle")
        {
            this.Bevel = Bevel;
            this.Length = Length;
            this.Width = Width;
