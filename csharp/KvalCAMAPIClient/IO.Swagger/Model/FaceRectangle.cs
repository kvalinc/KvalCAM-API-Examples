...
namespace IO.Swagger.Model
{
    ...
    public partial class FaceRectangle : AbstractFeature,  IEquatable<FaceRectangle>, IValidatableObject
    {
        ...
        public FaceRectangle(string Length = default(string), string Width = default(string), string Radius1 = default(string), string Radius2 = default(string), string Radius3 = default(string), string Radius4 = default(string), string DepthClosestToRef = default(string), string DepthFurthestFromRef = default(string), ClipPockets ClipPockets = default(ClipPockets), string Name = default(string), string Description = default(string), string TLocation = default(string), string WLocation = default(string), string LLocation = default(string), DoorSideEnum? DoorSide = default(DoorSideEnum?), List<AbstractFeature> Children = default(List<AbstractFeature>), string Type = "Circle") : base(Name, Description, TLocation, WLocation, LLocation, DoorSide, Children, Type)
        {
            this.Length = Length;
            this.Width = Width;
