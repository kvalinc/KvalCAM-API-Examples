...
namespace IO.Swagger.Api
{
    ...
    public interface IDoorJobsApi : IApiAccessor
    {
        ...
        /// </summary>
        /// <remarks>
        /// The id given is used to determine whether to perform an insert or an update, if the id already exists in the door job library then an update is performed, otherwise the door job is inserted. If no id is given or the id is all zeroes then no action is performed and a BadRequest (status 400) response is returned
        /// </remarks>
        /// <exception cref="IO.Swagger.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="parameters"> (optional)</param>
    ...
    public partial class DoorJobsApi : IDoorJobsApi
    {
        ...
        /// <summary>
        /// Inserts or updates a door job in the door job library The id given is used to determine whether to perform an insert or an update, if the id already exists in the door job library then an update is performed, otherwise the door job is inserted. If no id is given or the id is all zeroes then no action is performed and a BadRequest (status 400) response is returned
        /// </summary>
        /// <exception cref="IO.Swagger.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="parameters"> (optional)</param>
        /// <returns>UpsertDoorJobResponse</returns>
